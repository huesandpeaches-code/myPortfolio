  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Virtual Assistant and marketing operations support. Inbox, Meta Ads reporting, research, and clean systems. Remote from the Philippines.",
      },
